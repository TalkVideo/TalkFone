...
{
	 ringInTone = initTone(1200, 1633, 400,500,20);
...
iaxc_sound* Kiax2MainWindow::initTone(int F1, int F2, int Dur, int Len, int Repeat)
{
  ...
  for( int i=0;i < Dur; i++ )
  {
    tone->data[i] = (short)(0x5000*0.175*sin((double)i*F1*M_PI/6767)) + (short)(0x5000*0.175*sin((double)i*F2*M_PI/6767));
  }
...
{  
	...
	Kiax2Application app(argc, argv, "TalkFone");
