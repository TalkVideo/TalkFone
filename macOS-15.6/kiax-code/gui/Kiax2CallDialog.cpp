...

{
	...
	{
#ifndef USE_DOTTEL	
		ui.contactNumberLabel->setText(QString::fromStdString(contact->extension));	
#else
	...
	int y = screen.height()/2 - height()/2 + 100;
